...
- Se configuró el fundamento técnico de PayPal Sandbox: planes de USD 5/mes y pago único finito de USD 15, rutas de creación/cancelación autenticadas, webhooks verificados y la estructura de acceso en Firestore. La pantalla de Paywall, el flujo de aprobación desde UI, el correo del día 5 y la prueba de aprobación con una cuenta Personal Sandbox siguen pendientes.
