  ...
  return (
    <main className="paywall-shell">
      ...
      <style jsx>{`
        ...
        .paywall-close { position: absolute; z-index: 2; top: 0; right: 0; width: 38px; height: 38px; padding: 0; border: 1px solid rgba(222,216,225,.9); border-radius: 50%; background: rgba(255,253,249,.72); color: #69717D; display: grid; place-items: center; cursor: pointer; transition: background .2s ease, border-color .2s ease, color .2s ease; }.paywall-close:hover { background: #FFF; border-color: #D8CBDD; color: #3F4650; }.paywall-close:focus-visible { outline: 3px solid rgba(217,70,239,.22); outline-offset: 3px; }
