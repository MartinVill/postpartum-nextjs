  ...
  return (
    <main className="paywall-shell">
      <section className="paywall-content">
        ...
        <p className="paypal-note"><span aria-hidden="true">⌁</span> {paymentProvider.provider === 'google-play' ? isLifetime ? 'Procesado de forma segura mediante Google Play. Pago único, sin renovaciones.' : 'Procesado de forma segura mediante Google Play. Cancela cuando quieras desde tu cuenta.' : 'Procesamiento seguro por PayPal.'}</p>
