  ...
  return (
    <main className="paywall-shell">
      <section className="paywall-content">
        ...
        <footer className={`paywall-footer ${paymentProvider.provider === 'google-play' ? 'paywall-footer-with-restore' : ''}`}>
