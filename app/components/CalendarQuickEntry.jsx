    ...
    <>
      <div style={{
        ...
        <input
          ...
          style={{ flex: 1, minWidth: 0, border: 'none', outline: 'none', padding: '0 12px', fontSize: '13px', color: '#374151', background: 'transparent' }}
        />
        <div style={{ display: 'flex', gap: '3px', padding: '4px', borderRadius: '999px', background: '#F3F4F6', flexShrink: 0 }}>
          <button onClick={() => setType('evento')} style={{ border: 'none', borderRadius: '999px', padding: '6px 10px', fontSize: '9px', fontWeight: 600, cursor: 'pointer', background: type === 'evento' ? '#10B981' : 'transparent', color: type === 'evento' ? '#FFFFFF' : '#6B7280' }}>Evento</button>
          <button onClick={() => setType('sintoma')} style={{ border: 'none', borderRadius: '999px', padding: '6px 10px', fontSize: '9px', fontWeight: 600, cursor: 'pointer', background: type === 'sintoma' ? '#FBBF24' : 'transparent', color: type === 'sintoma' ? '#FFFFFF' : '#6B7280' }}>Síntoma</button>
        </div>
