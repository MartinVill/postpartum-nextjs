...
const styles = {
  screen: { minHeight: 'calc(100dvh - 86px)', boxSizing: 'border-box', background: '#FFFDF6', color: '#374151', padding: '20px 16px 16px', maxWidth: '600px', margin: '0 auto' },
  ...
  modalClose: { position: 'absolute', zIndex: 2, top: '17px', right: '18px', width: '44px', height: '44px', border: '1px solid rgba(255,255,255,0.32)', borderRadius: '50%', background: 'rgba(255,255,255,0.18)', color: '#D946EF', fontSize: '38px', lineHeight: 1, cursor: 'pointer', backdropFilter: 'blur(8px)' },
  moon: { position: 'absolute', zIndex: 2, top: '20px', left: '20px', width: '40px', height: '40px', border: '1px solid rgba(255,255,255,0.32)', borderRadius: '50%', background: 'rgba(255,255,255,0.18)', color: '#D946EF', fontSize: '30px', lineHeight: 1, cursor: 'pointer', backdropFilter: 'blur(8px)' },
